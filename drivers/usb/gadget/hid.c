...
static struct platform_device *kindle_hidg;

static int __init hidg_init(void)
{
	int status;

    kindle_hidg = platform_device_alloc("hidg", 0);
    kindle_hidg->dev.platform_data = &my_hid_data;
    platform_device_add(kindle_hidg);
...
static void __exit hidg_cleanup(void)
{
    ...
    platform_driver_unregister(kindle_hidg);
}
